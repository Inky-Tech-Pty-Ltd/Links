...
The reverse of this process would also be a task for the agent: The reverse is to verify the reputation claims of others.
...
3. Assess the reputational claims of others by checking its own data store, and by querying social graphs
